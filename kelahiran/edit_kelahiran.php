...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (
        ...
        $pesanError =
            "Berat lahir tidak valid.";
    } elseif (
        !is_numeric($panjang_lahir) ||
        (float) $panjang_lahir <= 0
    ) {
        $pesanError =
            "Panjang lahir tidak valid.";
    } elseif (
        filter_var(
            $usia_kehamilan,
            FILTER_VALIDATE_INT
...
BBLR apabila berat lahir kurang dari 2,5 kg.
</small>
...
<small class="text-muted d-block mt-2">
Prematur apabila usia kehamilan kurang dari 37 minggu.
</small>
...
<small class="text-muted">
Perbarui riwayat kehamilan ibu yang berkaitan
dengan kelahiran balita.
</small>
...
<div class="form-text">
Jika tidak ada komplikasi, isi dengan "Tidak ada".
</div>
